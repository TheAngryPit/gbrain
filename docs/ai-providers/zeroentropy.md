...
For PGLite, use the schema-aware reinitialization command:
...
The previous database is preserved at `<path>.bak`, and the configured brain
repo is synced again. For Postgres, follow
