...
The content above the second `---` is the current synthesis. The content below
it is the event/evidence timeline. Keep sourced claims in the timeline when they
